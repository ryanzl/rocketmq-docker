...
docker build -t apache/rocketmq-broker:4.1.0-incubating \
 ...
 --build-arg "BROKER_IP1=127.0.0.1" \
 --build-arg "BROKER_IP2=127.0.0.1" \
 ./broker
...
docker run -d -p 10911:10911 -p 10909:10909 --name rmqbroker --restart=always -m 2048m \
 ...
 -v /Users/ryanzl/docker-data/rocketmq/logs:/opt/logs \
 -v /Users/ryanzl/docker-data/rocketmq/store:/opt/store \
